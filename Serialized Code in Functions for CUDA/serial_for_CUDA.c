...
void initialize_weights(int num1, int num2, double **hidden);
void shuffle(int *array, size_t n);
//void train_and_test_allocate_memory();
void forward_propegation_hidden_layer1(int i, int num1, int num2, double * hidden_layer, double * bias, double **weights, double **inputs);
void forward_propegation_hidden_layer2(int i, int num1, int num2, double * hidden_layer, double * bias, double **weights, double *inputs);
void forward_propegation_output_layer(int i, int num1, int num2, double * output_layer, double * bias, double **weights, double *last_layer);
...
int main(int argc, char *argv[]) {
    ...
    trainingInputs = (double **)malloc(numTrain * sizeof(double *));
    for (int i = 0; i < numTrain; i++) {
        trainingInputs[i] = (double *)malloc(numInputs * sizeof(double));
    }

    testingInputs = (double **)malloc(numTest * sizeof(double *));
    for (int i = 0; i < numTest; i++) {
        testingInputs[i] = (double *)malloc(numInputs * sizeof(double));
    }

    trainingOutputs = (double **)malloc(numTrain * sizeof(double *));
    for (int i = 0; i < numTrain; i++) {
        trainingOutputs[i] = (double *)malloc(numOutputs * sizeof(double));
    }

    testingOutputs = (double *)malloc(numTest * sizeof(double));
